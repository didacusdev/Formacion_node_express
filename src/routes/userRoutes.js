...
router.get('/users', getUsers); // Configuramos la ruta para manejar las solicitudes GET a /users y llamamos al controlador getUsers
router.post('/users', postUser); // Configuramos la ruta para manejar las solicitudes POST a /users y llamamos al controlador postUser
